...
public class TextData : MonoBehaviour
{
    ...
    void generateData()
    {
        ...
        "주인공: 안돼, 너무 위험해:6$1",": …(아이는 금방이라도 울 것 같은 표정을 지었다):7$1","그럼 꼭 내 뒤에 붙어있어. 절대 앞으로 먼저 나가지 말고.:3$1","그럼 꼭 내 뒤에 붙어있어. 절대 앞으로 먼저 나가지 말고.:3$1",":7$2",":7$2",":7$1",":7$1",":7$1",":7$1",":7$1",":7$1",":7$1"});
